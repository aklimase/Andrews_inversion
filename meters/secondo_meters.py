...
#    if m >= 3.0:
#        magl.append(cat[i][1])
#        t = obspy.core.utcdatetime.UTCDateTime(cat[i][0].split('.')[0])
#        ev = str(t.year).zfill(4) + '_' + str(t.month).zfill(2) + '_' + str(t.day).zfill(2) + '_' + str(t.hour).zfill(2) + '_' + str(t.minute).zfill(2) + '_' + str(t.second).zfill(2)
#        event.append(ev)
...
#outfile_path = boxpath + '/secondo_3plus'
