...
secondo_ev =  glob.glob('/Users/escuser/project/boxes/all_paths/secondo/2*.out')
secondo_stn = glob.glob('/Users/escuser/project/boxes/all_paths/secondo/[!2]*.out')
freq_list = con.T[0] 
outfile_path = '/Users/escuser/project/boxes/all_paths/secondo_constrained'
