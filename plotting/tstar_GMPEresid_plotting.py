...
#out_dir = 'secondo_rebin3_constrained_2010_05_25_19_49_51'
...
h = [spec_levels[i]['1436Hzm'] for i in range(len(spec_levels))]
l_levels = zip(s,l)
m_levels = zip(s,m)
h_levels = zip(s,h)
...
def main():
    plot_3(x1 = l_levels, x2 = m_levels, x3 = h_levels, y = tstar ,vs30 = vs30, color = False, x1label = '1-6Hz amplitude (m)', x2label = '6-14Hz amplitude (m)', x3label = '14-36Hz amplitude (m)', ylabel = r'$\kappa_0$ (s)', outfilename = 'kappa_vs_spec_amp')
    plot_3(x1 = l_levels, x2 = m_levels, x3 = h_levels, y = site_terms ,vs30 = vs30, color = True, x1label = '1-6Hz amplitude (m)', x2label = '6-14Hz amplitude (m)', x3label = '14-36Hz amplitude (m)', ylabel = 'ln(GMPE site residual)', outfilename = 'GMPE_term_vs_spec_amp')
    plot_3(x1 = And_k, x2 = Kilb_kAH, x3 = Kilb_ksfix, y = tstar ,vs30 = vs30, color = False, x1label = 'Anderson kappa (s)', x2label = 'Kilb kappa AH (s)', x3label = 'Kilb kappa sfix (s)', ylabel = r'$\kappa_0$ (s)', outfilename = 'kappa_comp')
    plot_3(x1 = l_levels, x2 = m_levels, x3 = h_levels, y = vs30 ,vs30 = vs30, color = False, x1label = '1-6Hz amplitude (m)', x2label = '6-14Hz amplitude (m)', x3label = '14-36Hz amplitude (m)', ylabel = 'Vs30 (m/s)', outfilename = 'vs30_vs_spec_amp')
    plot_1(x = tstar, y = site_terms, vs30 = vs30, color = True, xlabel = r'$\kappa_0$ (s)', ylabel = 'ln(GMPE site residual)', outfilename = 'GMPE_term_vs_kappa')
    plot_1(x = tstar, y = vs30, vs30 = vs30, color = False, xlabel = r'$\kappa_0$ (s)', ylabel = 'Vs30 (m/s)', outfilename = 'lnvs30_vs_kappa')
    plot_1(x = vs30, y = site_terms, vs30 = vs30, color = False, xlabel = 'Vs30 (m/s)', ylabel = 'ln(GMPE site residual)', outfilename = 'GMPE_term_vs_lnvs30')
...
#    plot_3(x1 = l_levels, x2 = m_levels, x3 = h_levels, y = site_terms ,vs30 = vs30, color = True, x1label = '1-6Hz amplitude (m)', x2label = '6-14Hz amplitude (m)', x3label = '14-36Hz amplitude (m)', ylabel = 'ln(GMPE site residual)', outfilename = 'GMPE_term_vs_spec_amp_No_SOL_ERR')
...
#        ax.annotate(label3, xy=(0.02, 0.01), xycoords='axes fraction')
        ...
        ax.annotate(abc[ind], xy = (0.02, 0.94), xycoords='axes fraction', fontsize = 24, weight = 'bold')
    ...
    plt.show()
    plt.savefig(top_dir + '/tstar/site/' + out_dir + '/' + outfilename + '.png')
    
def plot_1(x, y, vs30, color, xlabel, ylabel, outfilename):
...
for i in range(len(l)):
    ...
    print 'vs30 vs '+ names[i] + ' MASW only'
    ...
    print 'lnvs30 vs' + names[i] + ' MASW only'
